...
| 順序 | スライス名 | 主要機能 | 依存 |
|------|-----------|---------|------|
| 1 | インフラ基盤 | FastAPIアプリ / Prismaスキーマ / ヘルスチェック | なし |
| 2-A | サンプルCSV | デモ用90件CSV生成・ダウンロード | インフラ基盤 |
| 2-B | CSV検算コア | アップロード / パース / 計算 / 冪等制御 / DB書込 | インフラ基盤 |
| 2-C | SSE進捗配信 | リアルタイム進捗ストリーム / 営業所別ステータス | インフラ基盤 |
| 3-A | 結果取得API | サマリ集約 / 営業所別 / 例外一覧 / 監査ログ | CSV検算コア |
| 3-B | 例外CSVエクスポート | 例外行のみCSV出力 | CSV検算コア |
| 4-A | OpenAI連携 | 例外理由文・推奨対応生成 | CSV検算コア |
| 4-B | Google Sheets連携 | 4シートbatch update | CSV検算コア |
| 4-C | Slack連携 | 例外通知（Block Kit） | CSV検算コア |
...
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 1.1 | FastAPIアプリ（main.py, CORS, エラーハンドラ） | - | [ ] | [ ] | [ ] | - | [ ] | - |
| 1.2 | Prismaスキーマ（jobs + invoices） | - | [ ] | [ ] | [ ] | - | [ ] | - |
| 1.3 | /api/health | GET | [ ] | [ ] | [ ] | - | [ ] | [ ] |
...
| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 2A.1 | /api/sample-csv | GET | [ ] | [ ] | [ ] | - | [ ] | [ ] |

#### スライス2-B: CSV検算コア

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 2B.1 | /api/upload（ファイル検証・ハッシュ生成） | POST | [ ] | [ ] | [ ] | - | [ ] | [ ] |
| 2B.2 | CSVパース＆数値正規化 | - | [ ] | [ ] | [ ] | - | [ ] | - |
| 2B.3 | 計算エンジン（税・値引き・差額判定） | - | [ ] | [ ] | [ ] | - | [ ] | - |
| 2B.4 | reason_code決定ロジック | - | [ ] | [ ] | [ ] | - | [ ] | - |
| 2B.5 | 冪等制御（hash+invoice_no UNIQUE） | - | [ ] | [ ] | [ ] | - | [ ] | - |
| 2B.6 | Job管理（queued→running→done/error） | - | [ ] | [ ] | [ ] | - | [ ] | - |

#### スライス2-C: SSE進捗配信

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 2C.1 | /api/stream/{job_id} | GET | [ ] | [ ] | [ ] | - | [ ] | [ ] |

#### スライス3-A: 結果取得API

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 3A.1 | /api/result/{job_id} | GET | [ ] | [ ] | [ ] | - | [ ] | [ ] |

#### スライス3-B: 例外CSVエクスポート

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 3B.1 | /api/export/exceptions/{job_id}.csv | GET | [ ] | [ ] | [ ] | - | [ ] | [ ] |

#### スライス4-A: OpenAI連携

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 4A.1 | OpenAI理由生成（upload pipeline統合） | - | [ ] | [ ] | [ ] | [ ] | [ ] | - |

#### スライス4-B: Google Sheets連携
